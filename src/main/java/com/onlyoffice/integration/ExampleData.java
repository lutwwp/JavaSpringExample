...
public class ExampleData {
    ...
    @PostConstruct
    public void init(){
        List<String> description_user_0= Arrays.asList(  // the description for user 0
        ...
        List<String> description_user_1 = Arrays.asList(  // the description for user 1
        ...
        List<String> description_user_2 = Arrays.asList(  // the description for user 2
        ...
        List<String> description_user_3 = Arrays.asList(  // the description for user 3
        ...
        userService.createUser("John Smith", "smith@example.com",  // create user 1 with the specified parameters
                ...
                Arrays.asList(FilterState.NULL.toString()),
                Arrays.asList(FilterState.NULL.toString()), null);
        userService.createUser("Mark Pottato", "pottato@example.com",  // create user 2 with the specified parameters
                ...
                Arrays.asList("group-2", ""), Arrays.asList("group-2"), true);
        userService.createUser("Hamish Mitchell", "mitchell@example.com",  // create user 3 with the specified parameters
                ...
                Arrays.asList("group-2"), new ArrayList<>(), false);
        userService.createUser("Anonymous",null,  // create user 0 with the specified parameters
                ...
                Arrays.asList(FilterState.NULL.toString()), Arrays.asList(FilterState.NULL.toString()), null);
    }
}
